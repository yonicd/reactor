...
```{r,echo=FALSE}
details::details('tests/testthat/test-goodreactivity.R',summary = 'Good Reactivity Test Script')
```

```{r,echo=FALSE}
details::details('tests/testthat/test-badreactivity.R',summary = 'Bad Reactivity Test Script')
```
