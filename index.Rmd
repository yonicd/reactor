...
author: 
  - "Jonathan Sidi"
date: 'Edinburgh R<br/><br/>https://bit.ly/36fTYFs'
output:
...
.center[![:scale 85%](media/reactor_01_a.svg)]
...
Web driver is via __{RSelenium}__ is initialized giving the ability to interact with the application. As app is reacting to the commands sent to it __{whereami}__ logs the reactivity events.

![](media/reactor_02_c.svg)
...
This will close both child processes that reactor is using and clean up the temp directory from sideffects.
...
.center[![:scale 50%](media/reactor_03_b.svg)]
...
.center[![:scale 60%](https://github.com/yonicd/reactor/raw/media/example_api.gif)]
...
.center[![:scale 80%](media/gha_2.png)]
---
